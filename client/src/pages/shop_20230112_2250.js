...
const Shop = () => {
  // Will Keep trying to get route to pass
...
// var cCategory = "Energy and Stress"   //  "Brain and Memory"
// console.log(cCategory)
//   if (typeof cCategory === 'undefined') {
//     // no parameter

//     const greeneFilter = greenes;
//     console.log("cCategory  Undefined!")
//   } else {
//     console.log("Parameter" + cCategory)
//     const greeneFilter = greenes.filter(greeneFilter => greeneFilter.category === cCategory)  //  WORKS
//   }
